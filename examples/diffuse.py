...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run forward diffusion on preprocessed data")
    parser.add_argument("raw_data", help="Undiffused raw data produced by make_training_data.py")
    parser.add_argument("noise_schedule", help="File with noise schedule for each diffusion timestep")
